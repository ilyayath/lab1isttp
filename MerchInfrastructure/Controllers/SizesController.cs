...
namespace MerchInfrastructure.Controllers
{
    public class SizesController : Controller
    {
        ...
        public SizesController(MerchShopeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SizeName,Id")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SizeName,Id")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
