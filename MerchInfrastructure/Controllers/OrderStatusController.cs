...
namespace MerchInfrastructure.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public OrderStatusController(MerchShopeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusName,Id")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusName,Id")] OrderStatus orderStatus)
        {
